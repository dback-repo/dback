...
cmd('docker run -d --name dback-test1.1 -v %CD%\\data\\mount-dir:/mount docker:19.03.5 tail -f /dev/null')
cmd('docker run -d --name dback-test1.2 -v %CD%\\data\\mount-dir:/mount docker:19.03.5 tail -f /dev/null')
